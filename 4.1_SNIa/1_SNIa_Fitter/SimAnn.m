function Params=SimAnn(InputParams,Data,r_vect,sigma_sample_data)
...
% with it.
OutStat=TimeSphereFitter(Params,Data,r_vect,sigma_sample_data);
T_start=OutStat;
...
while(T>T_crit)
    ...
    if((Test_Params(ParamInd)>=InputParams(ParamInd,1))&(Test_Params(ParamInd)<=InputParams(ParamInd,2)))            
        Test_OutStat=TimeSphereFitter(Test_Params,Data,r_vect,sigma_sample_data);        
    else        
