function RunThis
% This is the main code you should run for fitting the Union2.1 SNIa
% compilation to the baseline TimeSphere cosmology. RunThis.m runs a simulated
% annealing based fitting process 'TrialNum' number of times, each
% resulting with a set of fitted parameters given in a row of output file 
% 'Optimal_Params_[TrialNum/100].txt'. The last column in the output file 
% gives the measure of goodness of fit (in our case, the weighted sum of 
% squared deviations between data and the reference model, a.k.a. the 
% chi-squared statistic) corresponding to the parameter values in the 
% previous columns.
%
...
% - sigma_sample_data.dat, and 
% - SNIa_data.dat (and potentially outfiltered.txt) 
