...
OMarray - an array of potential dimensionless matter density parameter (Omega_m) values we use as an input parameter array for the LambdaCDM chi-square computing function.
...
# the radiation density parameter is negligible
...
# Finding the Hubble parameter and matter density parameter values for which chisq is the smallest in Timesphere cosmology
