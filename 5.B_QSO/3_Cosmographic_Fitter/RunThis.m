function RunThis
% This is the main code you should run for fitting the cosmographic
% distance modulus curve to the QSO dataset from Lusso, E., et al. A&A 642, 
% A150, 24 (2020); e-print: https://arxiv.org/abs/2008.08586. RunThis.m 
% runs a simulated annealing based fitting process 'TrialNum' number of 
% times, each resulting with a set of fitted parameters given in a row of 
% output file 'Optimal_Params_[TrialNum/100].txt'. The last column in the 
% output file gives the measure of goodness of fit (in our case, the 
